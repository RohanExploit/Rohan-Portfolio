    ...
    <div className="min-h-screen bg-obsidian">
      <div className="mx-auto max-w-4xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-lg border border-slate-600 bg-steel p-6 transition-all duration-300 hover:border-github-green hover:bg-steel">
              ...
              <a
                ...
                className="text-github-green hover:underline font-semibold"
              >
                {ROHAN_DATA.contact.email}
              </a>
              <p className="mt-2 text-sm text-text-secondary">
                Preferred for inquiries and collaborations
              </p>
            </div>
            ...
            <div className="rounded-lg border border-slate-600 bg-steel p-6">
              <h3 className="mb-4 font-mono font-bold text-text-primary">
                Connect on Social
              </h3>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className={`text-xs font-mono ${social.color}`}>
                          {social.handle}
                        </p>
                      </div>
                    </a>
          ...
          <div>
            <form
              ...
              className="space-y-6 rounded-lg border border-slate-600 bg-steel p-8"
            >
              {/* Name */}
              <div>
                <label
                  htmlFor="name"
                  className="block font-mono text-sm font-semibold text-text-primary mb-2"
                >
                  Name
                </label>
                <input
        ...
        <div className="mt-16 rounded-lg border border-github-green bg-github-green/5 p-8 text-center">
          <p className="font-mono text-sm uppercase text-github-green">
            Availability
          </p>
