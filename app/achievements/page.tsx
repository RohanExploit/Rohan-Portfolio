      ...
      <div className="mx-auto max-w-5xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          <p className="mt-6 text-xl text-text-secondary leading-relaxed max-w-2xl">
            A testament to continuous learning, community participation, and
              ...
              {certifications.map((achievement) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="mt-2 text-accent font-bold text-sm tracking-wide uppercase">
                      {achievement.issuer}
                    </p>
        ...
        <div className="grid gap-6 md:grid-cols-3 mb-20">
          {[
            ...
            <div
              key={index}
              className="glass-card p-10 text-center hover-lift border-accent/10 hover:border-accent"
            >
              <p className="font-mono text-5xl font-bold text-accent mb-2">
                {stat.count}
              </p>
        ...
        {ROHAN_DATA.testimonials.length > 0 && (
          <div className="mt-20">
            <h2 className="mb-10 font-mono text-3xl font-bold text-text-primary text-center">
              Global Recognition
            </h2>
            <div className="grid gap-8 md:grid-cols-2">
              {ROHAN_DATA.testimonials.map((testimonial) => (
                ...
                >
                  <div className="absolute top-4 right-8 text-8xl text-accent/5 font-serif select-none">
                    &quot;
                  </div>
                  <div className="relative z-10">
                    <div className="mb-6 flex gap-1">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          key={i}
                          className="h-5 w-5 fill-accent text-accent animate-pulse"
                    ...
                    <div className="border-l-4 border-accent pl-6">
                      <p className="font-mono text-lg font-bold text-text-primary group-hover:text-glow transition-all">
                        {testimonial.author}
                      </p>
                      <p className="text-sm text-accent font-bold uppercase tracking-widest mt-1">
                        {testimonial.role}
                      </p>
                    </div>
                  </div>
