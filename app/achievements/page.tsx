      ...
      <div className="mx-auto max-w-5xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="mt-4 text-text-secondary">
            Professional certifications, program achievements, and industry
            recognition.
          </p>
        </div>
        ...
        <div className="rounded-lg border border-slate-600 bg-steel p-8">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <div
                key={index}
                className="rounded-lg border border-accent/20 bg-accent/5 p-6 text-center"
              >
          ...
          <div className="mt-16">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {ROHAN_DATA.testimonials.map((testimonial) => (
                <div
                  key={testimonial.id}
                  className="rounded-lg border border-slate-600 bg-steel p-6"
                >
