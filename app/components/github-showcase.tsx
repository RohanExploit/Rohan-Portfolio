    ...
    <div className="w-full space-y-12">
      ...
      <div className="glass-card p-8 hover-lift">
        ...
        <div className="flex flex-wrap gap-3 justify-center sm:justify-start">
          <a
            href="https://discord.gg/Rohan_exploit"
            target="_blank"
          ...
          <a
            href="https://facebook.com/Rohan.opts"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Image
          ...
          <a
            href="https://instagram.com/Rohan.opts"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Image
          ...
          <a
            href="https://medium.com/@RohanExploit"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Image
          ...
          <a
            href="https://reddit.com/user/Charming_Wolf_2759"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Image
          ...
          <a
            href="https://youtube.com/@GreatestManOfWorld"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Image
          ...
          <a
            href="mailto:itzrohan007@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Image
      ...
      <div className="glass-card p-8 hover-lift">
        ...
        <div className="flex flex-wrap gap-3 justify-center sm:justify-start">
          ...
          />
          <Image
            src="https://img.shields.io/badge/React-%2320232a.svg?style=plastic&logo=react"
            alt="React"
            width={90}
            height={28}
            unoptimized
          />
          <Image
            src="https://img.shields.io/badge/Node.js-43853D?style=plastic&logo=node.js&logoColor=white"
            alt="Node.js"
            width={100}
            height={28}
            unoptimized
          ...
          />
          <Image
            src="https://img.shields.io/badge/AWS-232F3E?style=plastic&logo=amazonaws"
            alt="AWS"
            width={75}
            height={28}
            unoptimized
          ...
          />
          <Image
            src="https://img.shields.io/badge/MySQL-4479A1.svg?style=plastic&logo=mysql&logoColor=white"
            alt="MySQL"
            width={95}
            height={28}
            unoptimized
      ...
      <div className="glass-card p-8 text-center hover-lift border-2 border-accent/30">
        ...
        <p className="text-text-secondary mb-6 max-w-2xl mx-auto">
          All donations directly support development, hosting, and scaling of
          social-impact software projects, especially Vishwaguru, which focuses
          on public grievance reporting and civic transparency.
        </p>
        <a
          href="https://buymeacoffee.com/rohanexploit"
          target="_blank"
          rel="noopener noreferrer"
        >
          <Image
