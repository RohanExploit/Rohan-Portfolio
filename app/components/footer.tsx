      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 md:grid-cols-4 lg:gap-16">
          ...
          <div className="col-span-2 space-y-6">
            <Link
              href="/"
              className="font-mono text-2xl font-bold tracking-tighter text-text-primary"
            >
              ROHAN<span className="text-accent">.</span>
            </Link>
            <p className="max-w-md text-text-secondary leading-relaxed">
              Full-stack developer and AI enthusiast dedicated to building
              scalable solutions and contributing to the open-source community.
          ...
          <div className="space-y-6">
            <h3 className="font-mono text-sm font-bold text-accent uppercase tracking-widest">
              Navigation
            </h3>
