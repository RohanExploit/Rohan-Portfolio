...
export default function GlitchTerminal() {
    ...
    return (
        <div className="font-mono relative">
            {/* CRT Scanlines */}
            <div className="absolute inset-0 pointer-events-none z-10 bg-gradient-to-b from-transparent via-black/5 to-transparent bg-repeat-y animate-pulse"
                style={{ backgroundSize: '100% 4px' }} />

            {/* Terminal Window */}
            <div className={`relative rounded-lg border-2 border-accent bg-black/90 backdrop-blur-sm shadow-[0_0_30px_rgba(57,255,20,0.3)] ${glitch ? 'animate-pulse' : ''}`}>
                {/* Terminal Header */}
                <div className="border-b-2 border-accent/30 bg-black/50 px-4 py-3 flex items-center justify-between">
                    ...
                    <span className="text-xs text-accent font-bold tracking-widest">root@ROHAN:~</span>
