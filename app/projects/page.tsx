            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="mt-2 text-sm text-github-green font-semibold">{project.subtitle}</p>
                  </div>
                  <button
              ...
              {expandedId === project.id && (
                <div className="space-y-6 border-t border-slate-600 pt-6">
                  ...
                  <div>
                    <h4 className="font-mono font-semibold text-github-green mb-3 text-lg">Key Features</h4>
                  ...
                  <div>
                    <h4 className="font-mono font-semibold text-github-green mb-3 text-lg">Impact</h4>
