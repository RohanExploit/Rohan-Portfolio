    ...
    <div className="min-h-screen bg-background text-text-primary">
      <div className="mx-auto max-w-6xl px-4 py-24 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 animate-in fade-in slide-in-from-top duration-700">
          <p className="font-mono text-sm text-accent uppercase tracking-widest font-bold">/projects</p>
          <h1 className="mt-4 font-mono text-5xl font-bold text-text-primary tracking-tighter">Featured Projects</h1>
          <p className="mt-6 text-xl text-text-secondary max-w-2xl leading-relaxed">A selection of projects spanning full-stack development, AI/ML, and open-source contributions.</p>
        </div>
                ...
                <div className="flex-1 p-8 lg:p-12">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="mt-2 text-sm font-bold text-accent tracking-wider uppercase">{project.subtitle}</p>
                    </div>
                    <button
                  ...
                  <p className="mt-6 text-text-secondary leading-relaxed text-lg">{project.description}</p>
                  ...
                  {expandedId === project.id && (
                    <div className="space-y-8 border-t border-border pt-8 mt-8 animate-in fade-in slide-in-from-top duration-500">
                      <div>
                        <h4 className="font-mono font-bold text-accent mb-4 text-sm uppercase tracking-widest">Full Description</h4>
                        <p className="text-text-secondary leading-relaxed">{project.fullDescription}</p>
                      </div>

                      <div className="grid md:grid-cols-2 gap-8">
                        <div>
                          <h4 className="font-mono font-bold text-accent mb-4 text-sm uppercase tracking-widest">Key Features</h4>
                        ...
                        <div>
                          <h4 className="font-mono font-bold text-accent mb-4 text-sm uppercase tracking-widest">Impact</h4>
                          <p className="text-text-secondary leading-relaxed text-sm italic">"{project.impact}"</p>
        ...
        <div className="mt-24 grid gap-8 border-t border-border pt-16 md:grid-cols-3">
          {[
            ...
            <div key={index} className="glass-card p-10 text-center hover-lift group border-transparent hover:border-accent">
              <div className="text-accent text-2xl mb-4 opacity-50">{stat.icon}</div>
              <p className="font-mono text-sm text-text-secondary uppercase tracking-widest font-bold">{stat.label}</p>
              <p className="mt-4 font-mono text-4xl font-bold text-text-primary group-hover:text-glow transition-all">{stat.value}</p>
            </div>
          ))}
        </div>
      </div>
